export const TwitchBlackIcon = ({ ...props }) => (
...
export const TwitchPurpleIcon = ({ ...props }) => (
  <svg viewBox="0 0 2500 2800" xmlns="http://www.w3.org/2000/svg" {...props}>
    <g>
      <polygon
        points="2200,1300 1800,1700 1400,1700 1050,2050 1050,1700 600,1700 600,200 2200,200"
        fill="#FFFFFF"
      ...
      <g>
        <g id="Layer_1-2">
          <path
            ...
            fill="#9146FF"
          />
          <rect x="1700" y="550" width="200" height="600" fill="#9146FF" />
          <rect x="1150" y="550" width="200" height="600" fill="#9146FF" />
        </g>
      </g>
    </g>
  </svg>
...
export const TwitchViewerIcon = ({ ...props }) => {
  return (
    <svg
      width="20"
      height="20"
